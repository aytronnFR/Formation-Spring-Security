...
public class AuthenticationService {
    ...
    public LocalUser updaterole(HttpServletRequest request, UpdateRoleDto roleDto){
       ...
       LocalUser userRepository = getUserRepository().findByUsername(username).orElseThrow();
       userRepository.setRole(roleDto.role());
       return getUserRepository().save(userRepository);
